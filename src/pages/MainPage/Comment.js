    ...
    return (
        <>
            ...
            <ButtonGroup disableElevation variant="outlined" color="primary">
                <Button onClick={() => openListOfComments(postId)} disabled={length === 0}>see comments</Button>
                <Button onClick={addComment} disabled={user.token === null}>Add comment</Button>
            </ButtonGroup>
            {openComments
                 ...
                 {commentsForPost?.map((comment, index) => (
                     <div key={index}>
                         ...
                         <Grid container wrap="nowrap" spacing={2}>
                             <Grid item>
                                 <Avatar alt="Remy Sharp" src={comment.user.profilePic === null
                                                               ? defaultAvatarPicUrl
